  ...
  <div class="space-y-8">
    ...
    <div class="text-center">
      ...
      <p class="text-sm text-gray-500">
        {{ blogStore.totalBlogs }} post{{ blogStore.totalBlogs !== 1 ? 's' : '' }} in this category
      </p>
    </div>
...
const loadCategoryPosts = async () => {
  try {
    ...
    const allCategories = await blogStore.fetchCategories()
    category.value = allCategories.find(cat => cat.slug === categorySlug)
    ...
    await blogStore.fetchBlogsByCategory(categorySlug, {
      page: blogStore.currentPage,

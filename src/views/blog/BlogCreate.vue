<template>
  <div class="space-y-8">
    ...
    <!-- Form -->
    <form @submit.prevent="publishPost" class="space-y-8">
    ...
    <!-- Error Message -->
    <div v-if="blogStore.error" class="rounded-md bg-red-50 p-4">
      <div class="flex">
...
const saveDraft = async () => {
  ...
  try {
    ...
    const response = await blogStore.createBlog(form.value)
